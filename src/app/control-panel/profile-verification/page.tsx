...
import VerificationRequestTable from '@/components/chrono-feed/verification-request-table';
          ...
          <div className="p-4 sm:p-6 lg:p-8 w-full max-w-5xl mx-auto">
            <div className="mb-6 flex items-center gap-4">
                 ...
                 <div>
                    ...
                    <p className="text-muted-foreground">Review and approve or deny user profile verification requests.</p>
                 </div>
            </div>
