...
import { Users, FileText, BarChart3, Shield, ShieldCheck } from 'lucide-react';
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                />
                 <ControlPanelCard 
                    ...
                    description="Review and approve or deny user profile verification requests." 
                    icon={ShieldCheck}
                    href="/control-panel/profile-verification"
                />
            </div>
          </div>
        </main>
